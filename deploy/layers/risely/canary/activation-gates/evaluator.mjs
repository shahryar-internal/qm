...
export const bundledManifestSha256 = "5dbf20f0c6b14d1e093f99ed470a788c5e5169388af6e4b099a2d34c664e8ec0";
...
const closedEvidence = Object.freeze([
  ...
  Object.freeze({
    ...
    kind: "source",
    sha256: "23070b9feb820a2c12486dba26dc3df275f05fa9c6ba4cfa9e19d940ae18b192",
  }),
  Object.freeze({
  ...
  Object.freeze({
    id: "postgres_database_connection_source",
    path: "canary/service/ceo-canary/src/database-connection.mjs",
    kind: "source",
    sha256: "ae4ff953e9d139c4b257fcd67d16bab65be4d1d15f77f99b046be1d090525c7a",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    kind: "source",
    sha256: "f87fc34c2313da85e2fed9a6f268dea5ee7b15468788cd1c5dd57760f2450f3b",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    kind: "source",
    sha256: "12f0c1cacca52eb5bd52138648bd2371d6e089ce14e78c967a23f1564f0d0153",
  }),
  Object.freeze({
    id: "postgres_credential_provisioner_source",
    path: "canary/service/ceo-canary/src/provision-credentials.mjs",
    kind: "source",
    sha256: "c3d86e148fc8213e68c27edebcfa5c2db7329cb155dac7ab2bde7af0444e68dd",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    kind: "test",
    sha256: "0e4320ec2caf390328e4842a7f9d323c9e29def0b8b0b71921c975e7e537922a",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    kind: "source",
    sha256: "02f96dcde3648d2349444d5b7f0b5a3232fd7a3641210a5aea559a5ab0710069",
  }),
  Object.freeze({
    id: "ceo_canary_migration_runbook",
    path: "canary/service/ceo-canary/migrations/RUNBOOK.md",
    kind: "source",
    sha256: "8f902eb89b6d41c0a6b0fc58838746bf7f71d6cd8c2da3aad2f6d28f1de3904e",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    kind: "source",
    sha256: "ef75307a133223f7dd756643927f22a80da0ea4bf04bbf037f1aa88b58b51e44",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    kind: "test",
    sha256: "2620f9e63839c2d61edf6d96997989891bbb5bccb264a97f1872ae1d8407206c",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    kind: "source",
    sha256: "e32a936442075965d1df365ee423c3688ca15e7350253d223a94bb2bed903ce0",
  }),
  Object.freeze({
    id: "postgres_db_operator_dockerfile_source",
    path: "canary/service/ceo-canary/Dockerfile.db-operator",
    kind: "source",
    sha256: "4554bfe48b181f654c443e6e8341c9aab77d830b9677f4563dd8e96d97f519cd",
  }),
  Object.freeze({
    id: "postgres_db_operator_package_source",
    path: "canary/service/ceo-canary/db-operator/package.json",
    kind: "source",
    sha256: "c0997aa317cd42737e8e51088fe45c633a660b7bbbdc3932dafa3d83e0960595",
  }),
  Object.freeze({
    id: "postgres_db_operator_lock_source",
    path: "canary/service/ceo-canary/db-operator/package-lock.json",
    kind: "source",
    sha256: "7c39cb0a04cc9ea2ae643bc6498693d4253f765c31e72d66679543cf9ecd1c16",
  }),
  Object.freeze({
...
const closedGates = Object.freeze([
  ...
  Object.freeze({
    ...
    evidence: Object.freeze([
      ...
      "postgres_database_connection_source",
      ...
      "postgres_db_operator_package_source",
      "postgres_db_operator_lock_source",
...
const safeEvidencePath = (value) => {
  if (
    ...
    value.includes("\u0000") ||
    (![
      "canary/service/ceo-canary/Dockerfile",
      "canary/service/ceo-canary/Dockerfile.db-operator",
      "canary/service/ceo-canary/Dockerfile.runtime",
    ].includes(value) &&
